...
export async function exportProjectsPDF(projects) {
    ...
    const printContent = `
        ...
        <html>
        <head>
            <title>My Hearst AI - Projects Report</title>
            <style>
        ...
        <body>
            <h1>My Hearst AI Projects Report</h1>
...
export async function exportJobsPDF(jobs) {
    const printContent = `
        ...
        <html>
        <head>
            <title>My Hearst AI - Jobs Report</title>
            <style>
                body { font-family: Arial, sans-serif; padding: 40px; }
                h1 { color: #a5ff9c; border-bottom: 2px solid #a5ff9c; padding-bottom: 10px; }
        ...
        <body>
            <h1>My Hearst AI Jobs Report</h1>
            <p><strong>Generated:</strong> ${new Date().toLocaleString()}</p>
...
export async function exportDashboardPDF(stats, projects, jobs) {
    const printContent = `
        ...
        <html>
        <head>
            <title>My Hearst AI - Dashboard Report</title>
            <style>
                body { font-family: Arial, sans-serif; padding: 40px; }
                h1 { color: #a5ff9c; border-bottom: 2px solid #a5ff9c; padding-bottom: 10px; }
        ...
        <body>
            <h1>My Hearst AI Dashboard Report</h1>
            <p><strong>Generated:</strong> ${new Date().toLocaleString()}</p>
