    ...
    <div className="dashboard-view">
      <div className="dashboard-content">
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 'var(--space-6)', flexWrap: 'wrap', gap: 'var(--space-4)' }}>
          <div>
            <h1 style={{ fontSize: 'var(--text-xl)', fontWeight: 600, marginBottom: 'var(--space-2)', color: 'var(--text-primary)' }}>
            ...
            <div style={{ padding: 'var(--space-6)', background: 'var(--bg-tertiary)', borderRadius: 'var(--radius-md)' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-6)' }}>
                <div>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-2)', marginLeft: 'var(--space-4)' }}>
                    <div style={{ fontFamily: 'var(--font-mono), monospace', fontSize: 'var(--text-sm)', color: 'var(--text-secondary)' }}>
                      GET /customers
                    </div>
                    <div style={{ fontFamily: 'var(--font-mono), monospace', fontSize: 'var(--text-sm)', color: 'var(--text-secondary)' }}>
                      GET /customers/&#123;id&#125;
              ...
              <div
                style={{
                  ...
                  padding: 'var(--space-4)',
                  background: 'rgba(167, 251, 144, 0.05)',
